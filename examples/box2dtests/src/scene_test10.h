...
namespace Test10 {
	...
	struct DroppingItem : SceneItem {
		...
		static constexpr float cSpeed{ 300.f / gg.cFps };
		xx::Frame frame;
		int32_t _1{};
		XY inc{};
		bool flipX{};
		int32_t numSteps{}, step{};
		float maxYOffset{}, yOffset{}, scale2{}, scale2Ratio{}, alpha{};
	...
	struct Scene : xx::SceneBase {
		...
		float dropFromRangeRadius{}, dropFromRangeRadiusSafe{};
		float dropToRangeRadius{}, dropToRangeRadiusSafe{};
