...
void Scene_MainMenu::MakeUI() {
	...
	L.Append(C->Make<xx::LabelButton>()->Init(2, 0, 0, fontSize)("test5 ( man1 )")).onClicked = [this] {
	...
	L.Append(C->Make<xx::LabelButton>()->Init(2, 0, 0, fontSize)("test7 ( grass1 )")).onClicked = [this] {
